<?php
    ...
    //$backgroundImage = !empty($headerData['background_image']) ? $headerData['background_image'] : ''; 
?>
    ...
    <div class="header__content">
        <div class="header__flex header__wrapper">
            <?php if(!empty($heading)): ?>
                <h1 class="header__heading styles__h1--long color--white spacing__mvn"><?=$heading?></h1>
            <?php endif; ?>
            <div class="header__desc">
                <?php if(!empty($copy)): ?>
                    <p class="header__copy color--white spacing__mtn"><?=$copy?></p>
                <?php endif; 
                if(!empty($ctaText)): ?>
